...
//! ```ignore
//! use stardust_media_common::{MediaKind, ImageValidator};
//!
//! // 验证用户上传的照片
...
//! ```ignore
//! use stardust_media_common::{HashHelper, IpfsHelper, ContentType};
//!
//! // 计算证据承诺哈希
...
//! ```ignore
//! use stardust_media_common::{VideoValidator, AudioValidator};
//!
//! // 验证聊天中的视频和音频
