...
4. ✅ **随机金额**：每笔转账金额在 20,000,000-50,000,000 MEMO 范围内随机
5. ✅ **结果记录**：保存所有转账结果到文件
...
**计算所需余额**：
- 账户数量：1000
- 平均金额：35,000,000 MEMO（20-50百万的中间值）
- 总转账金额：1000 × 35,000,000 = 35,000,000,000 MEMO（350亿）
- 预估手续费：约 1000笔 × 0.01 MEMO = 10 MEMO
- **需要总额**：约 35,000,000,010 MEMO
...
📋 生成转账列表...
==========================================================
总转账金额: 35,234,567,890 MEMO
总笔数: 1000
平均金额: 35,234,567 MEMO
预估总手续费: 10 MEMO
单笔手续费: 0.01 MEMO
需要总额: 35,234,567,900 MEMO
✅ 余额充足
...
💰 最终余额查询...
   初始余额: 100,000,000,000 MEMO
   最终余额: 64,765,432,100 MEMO
   实际花费: 35,234,567,900 MEMO
  ...
  "results": [
    {
      ...
      "amountFormatted": "23,456,789 MEMO",
      "success": true,
    ...
    },
    {
      ...
      "amountFormatted": "45,678,901 MEMO",
      "success": false,
...
**回答**：
- 配置的金额范围是 20,000,000-50,000,000 MEMO
- 这是**整数金额**，不是最小单位
- MEMO 代币精度为12位小数
- 实际最小单位金额 = 配置金额 × 10^12
...
**示例**：
```
配置: minAmount = 20_000_000n (20,000,000 MEMO)
精度: 12
...
```javascript
const BATCH_CONFIG = {
  minAmount: 10n,        // 最小 10 MEMO
  maxAmount: 100n,       // 最大 100 MEMO
  // ...
};
```
