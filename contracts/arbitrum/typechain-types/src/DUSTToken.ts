...
export interface DUSTTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BRIDGE_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export namespace BurnedEvent {
  ...
  export type OutputTuple = [from: string, amount: bigint, bridgeId: string];
  export interface OutputObject {
    from: string;
    amount: bigint;
    bridgeId: string;
...
export namespace MintedEvent {
  ...
  export type OutputTuple = [to: string, amount: bigint, bridgeId: string];
  export interface OutputObject {
    to: string;
    amount: bigint;
    bridgeId: string;
...
export interface DUSTToken extends BaseContract {
  connect(runner?: ContractRunner | null): DUSTToken;
  waitForDeployment(): Promise<this>;

  interface: DUSTTokenInterface;
  ...
  burn: TypedContractMethod<
    [from: AddressLike, amount: BigNumberish, bridgeId: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  mint: TypedContractMethod<
    [to: AddressLike, amount: BigNumberish, bridgeId: BytesLike],
    [void],
    "nonpayable"
  >;
