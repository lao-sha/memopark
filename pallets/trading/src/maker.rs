...
use crate::pallet::{Config, BalanceOf, Cid, TronAddress};
...
/// # 返回
/// - DispatchResult
pub fn do_submit_info<T: Config>(
    who: &T::AccountId,
    real_name: Vec<u8>,
    ...
    use crate::pallet::{AccountToMaker, MakerApplications, Pallet, Event, Error};
...
/// # 返回
/// - DispatchResult
pub fn do_approve_maker<T: Config>(maker_id: u64, approved_by: &T::AccountId) -> DispatchResult {
    use crate::pallet::{MakerApplications, Pallet, Event, Error};
...
/// # 返回
/// - DispatchResult
pub fn do_reject_maker<T: Config>(maker_id: u64, rejected_by: &T::AccountId) -> DispatchResult {
    use crate::pallet::{MakerApplications, Pallet, Event, Error};
...
/// # 返回
/// - DispatchResult
pub fn do_cancel_maker<T: Config>(who: &T::AccountId) -> DispatchResult {
    use crate::pallet::{AccountToMaker, MakerApplications, Pallet, Event, Error};
...
/// # 返回
/// - DispatchResult
pub fn do_request_withdrawal<T: Config>(who: &T::AccountId, amount: BalanceOf<T>) -> DispatchResult {
    use crate::pallet::{AccountToMaker, MakerApplications, WithdrawalRequests, Pallet, Event, Error};
...
/// # 返回
/// - DispatchResult
pub fn do_execute_withdrawal<T: Config>(who: &T::AccountId) -> DispatchResult {
    use crate::pallet::{AccountToMaker, MakerApplications, WithdrawalRequests, Pallet, Event, Error};
...
/// # 返回
/// - DispatchResult
pub fn do_cancel_withdrawal<T: Config>(who: &T::AccountId) -> DispatchResult {
    use crate::pallet::{AccountToMaker, WithdrawalRequests, Pallet, Event, Error};
...
/// # 返回
/// - DispatchResult
pub fn do_emergency_withdrawal<T: Config>(maker_id: u64, to: &T::AccountId) -> DispatchResult {
    use crate::pallet::{MakerApplications, Pallet, Event, Error};
