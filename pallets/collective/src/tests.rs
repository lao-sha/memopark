...
fn close_with_no_prime_but_majority_works() {
    ExtBuilder::default().build_and_execute(|| {
        ...
        assert_ok!(CollectiveMajority::release_proposal_cost(
            RuntimeOrigin::signed(5),
            hash
        ));
        ...
        assert_eq!(
            ...
            vec![
                ...
                record(RuntimeEvent::CollectiveMajority(
                    CollectiveEvent::ProposalCostReleased {
                        proposal_hash: hash,
                        who: 5,
                    }
                ))
    ...
    ExtBuilder::default().build_and_execute(|| {
        ...
        assert_eq!(
            ...
            vec![
                ...
                record(RuntimeEvent::Collective(
                    CollectiveEvent::ProposalCostBurned {
