...
mod benchmarks {
        ...
        if m > 0 {
            ...
            for i in 0..p {
                ...
                let proposal: T::Proposal = SystemCall::<T>::remark {
                    remark: id_to_remark_data(i, length),
                }
                .into();
    ...
    fn execute(
        ...
        let proposal: T::Proposal = SystemCall::<T>::remark {
            remark: id_to_remark_data(1, b as usize),
        }
        .into();
    ...
    fn propose_proposed(
        ...
        for i in 0..p - 1 {
            ...
            // Proposals should be different so that different proposal hashes are generated
            let proposal: T::Proposal = SystemCall::<T>::remark {
                remark: id_to_remark_data(i, b as usize),
            }
            .into();
            Collective::<T, I>::propose(
                SystemOrigin::Signed(caller.clone()).into(),
        ...
        let proposal: T::Proposal = SystemCall::<T>::remark {
            remark: id_to_remark_data(p, b as usize),
        }
        .into();
        #[extrinsic_call]
        propose(
    ...
    fn close_early_disapproved(
        ...
        for i in 0..p {
            ...
            // Proposals should be different so that different proposal hashes are generated
            let proposal: T::Proposal = SystemCall::<T>::remark {
                remark: id_to_remark_data(i, bytes as usize),
            }
            .into();
            Collective::<T, I>::propose(
                SystemOrigin::Signed(proposer.clone()).into(),
