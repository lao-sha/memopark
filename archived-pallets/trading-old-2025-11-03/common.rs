...
use crate::{Config, TronTxUsed, TronTxQueue};
...
pub fn record_tron_tx_hash<T: Config + frame_system::Config>(tx_hash: H256) -> DispatchResult {
...
/// # 返回
/// - Weight: 消耗的权重
pub fn clean_tron_tx_hashes<T: Config + frame_system::Config>(current_block: BlockNumberFor<T>) -> Weight {
